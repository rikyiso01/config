...
let
  homeManager = rec {
    ...
    programs.fish = {
      shellAliases = {
        music-update = "nix shell nixpkgs#yt-dlp --command nix run ${home.homeDirectory}/backup/Documents/Projects/Python/musicmanager auto Music Music2 Music3 Music4 Music5 Bardify Clownpierce Dream FlameFrags Halloween Wemmbu Tensura";
        timg = "timg -ps";
