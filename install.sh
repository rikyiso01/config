...
sudo pamac install --no-confirm flatpak nix virtualbox xdg-desktop-portal-gnome virtualbox-host-dkms manjaro-settings-manager xdg-desktop-portal-wlr pipewire-media-session manjaro-pipewire
