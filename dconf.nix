...

{
  dconf.settings = {
    ...
    "org/gnome/desktop/notifications" = {
      application-children = [ "org-gnome-console" "gnome-power-panel" "org-gnome-texteditor" "org-gnome-shell-extensions-gsconnect-preferences" "org-gnome-shell-extensions-gsconnect" "code" "org-gnome-geary" "firefox" "org-gnome-extensions" "org-gnome-baobab" ];
    };
